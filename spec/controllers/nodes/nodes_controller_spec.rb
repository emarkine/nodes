...
module Nodes
  RSpec.describe NodesController, type: :controller do
    ...
    describe "GET #edit" do
      it "returns a success response" do
        node = Node.create! valid_attributes
        get :edit, params: {id: node.to_param}, session: valid_session
        expect(response).to be_success
      end
    end
    ...
    describe "POST #create" do
      context "with valid params" do
        it "creates a new Node" do
          expect {
            post :create, params: {node: valid_attributes}, session: valid_session
      ...
      context "with invalid params" do
        it "returns a success response (i.e. to display the 'new' template)" do
          post :create, params: {node: invalid_attributes}, session: valid_session
          expect(response).to be_success
        end
      end
    end
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested node" do
          node = Node.create! valid_attributes
          put :update, params: {id: node.to_param, node: new_attributes}, session: valid_session
          node.reload
        ...
        it "redirects to the node" do
          node = Node.create! valid_attributes
          put :update, params: {id: node.to_param, node: valid_attributes}, session: valid_session
      ...
      context "with invalid params" do
        it "returns a success response (i.e. to display the 'edit' template)" do
          node = Node.create! valid_attributes
          put :update, params: {id: node.to_param, node: invalid_attributes}, session: valid_session
          expect(response).to be_success
        end
      end
    end
    ...
    describe "DELETE #destroy" do
      it "destroys the requested node" do
        node = Node.create! valid_attributes
        expect {
          delete :destroy, params: {id: node.to_param}, session: valid_session
        }.to change(Node, :count).by(-1)
      end
